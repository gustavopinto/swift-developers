...
The complete list of optional-related questions is available [here](list-optional-questions). The questions we analyzed is available below:

id_question|score|viewCount|answerCount|commentCount|favoriteCount|tags|value
-----------|-----|---------|-----------|------------|-------------|----|-----
